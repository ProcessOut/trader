...
var (
	validCurrencies = map[CurrencyCode]CurrencyInformation{
		...
		"COU": CurrencyInformation{970, 2, "Unidad de Valor Real (UVR) (funds code)[7]", []string{"Colombia"}},
		...
		"ILS": CurrencyInformation{376, 2, "Israeli new shekel", []string{"Israel", "State of Palestine (PS)[8]"}},
		...
		"XSU": CurrencyInformation{994, -1, "SUCRE", []string{"Unified System for Regional Compensation (SUCRE)[10]"}},
		"XTS": CurrencyInformation{963, -1, "Code reserved for testing purposes", []string{}},
		"XUA": CurrencyInformation{965, -1, "ADB Unit of Account", []string{"African Development Bank[11]"}},
